...
\>[B]{}\mbox{\enskip\{-\# OPTIONS_GHC -XNPlusKPatterns  \#-\}\enskip}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv1}\;\Varid{x}\mathrel{=}\mathsf{for}\ ((\mathrm{1}\mathbin{+})\comp ((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*}))\ \mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{23}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invpw}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{invpw}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{maclaurin}\;\Varid{n}\mathbin{+}\Varid{invpw}\;\Varid{x}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{maclaurin}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{maclaurin}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*}\Varid{maclaurin}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
%
    \ensuremath{\Varid{f}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{f}}{\Varid{g}}\;\Varid{e}\;\Varid{g}\comp \mathbf{in}\mathrel{=}\Varid{k}\comp \Conid{F}\;\conj{\Varid{f}}{\Varid{g}}}
%
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invc}\;\Varid{x}\mathrel{=}\p2\comp \Varid{cataNat}\;\conj{\alt{\underline{(\mathrm{1})}}{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\comp \p1}}{\alt{\underline{(\mathrm{1})}}{\Varid{add}\comp (((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\times\Varid{id})}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
         \ensuremath{\conj{\Varid{h}}{\Varid{k}}}
%
\just={Definição de h e k}
%
        \ensuremath{\conj{\alt{\underline{\mathrm{1}}}{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\times\Varid{id}}}{\alt{\underline{\mathrm{1}}}{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\comp \p1}}}
%
\just={Lei da Troca}
%
        \ensuremath{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\times\Varid{id}}{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\comp \p1}}}
%
\end{eqnarray*}
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 invfokk}\mathbin{::}\Conid{Double}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 invfokk}\;\Varid{num}\mathrel{=}(\Varid{num}\mathbin{>}\mathrm{1}\mathrel{\wedge}\Varid{num}\mathbin{<}\mathrm{2})\mathbin{==>}\Varid{abs}\;(\Varid{a}\mathbin{-}\Varid{b})\leq \mathrm{0.000000000000009}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{a}\mathrel{=}\Varid{inv}\;\Varid{num}\;\mathrm{500000}{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{b}\mathrel{=}\mathrm{1}\mathbin{/}\Varid{num}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{worker}\mathrel{=}\Varid{cataList}\;\alt{\conj{\underline{\Conid{True}}}{\underline{\mathrm{0}}}}{\conj{\Varid{sep}\comp \p1}{\Varid{cond}\;(\uncurry{(\mathrel{\wedge})}\comp ((\neg \comp \Varid{sep})\times\p1))\;(\succ \comp \p2\comp \p2)\;(\p2\comp \p2)}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{sep}\;\Varid{c}\mathrel{=}(\Varid{c}\equiv \text{\tt '~'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 n'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 t'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
%
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\underline{\Conid{True}}}{\Varid{sep}\comp \p1}}
%
\end{eqnarray*}
...
%
        \ensuremath{\Varid{look}\comp \mathbf{in}\mathrel{=}\alt{\underline{\Conid{True}}}{\Varid{sep}\comp \p1}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\mathbin{<}\Varid{lookahead\char95 sep},\Varid{wc\char95 w}\mathbin{>}))} \\
        \ensuremath{\Varid{wc\char95 w}\comp \mathbf{in}\mathrel{=}} \\
        \ensuremath{\alt{\underline{\mathrm{0}}}{\Varid{cond}\;((\mathrel{\wedge})\comp (\neg \comp \Varid{sep}\times\p1))\;(\succ \comp \p2\comp \p2,\p2\comp \p2)}\comp (\Varid{id}\mathbin{+}(\Varid{id}\times\conj{\Varid{lookahead\char95 sep}}{\Varid{wc\char95 w}}))}
%
\\
\\
\just={Lei 50 - Fokkinga}
%
        \ensuremath{\Varid{cataList}\;\conj{\alt{\underline{\Conid{True}}}{\Varid{sep}}\comp \p1}{\alt{\underline{\mathrm{0}}}{\Varid{cond}\;((\mathrel{\wedge})\comp (\neg \comp \Varid{sep}\times\p1))\;(\succ \comp \p2\comp \p2,\p2\comp \p2)}}}
%
\\
\\
\just={Lei 28 - Lei da troca}
%
        \ensuremath{\Varid{cataList}\;\alt{\conj{\underline{\Conid{True}}}{\underline{\mathrm{0}}}}{\conj{\Varid{sep}\comp \p1}{\Varid{cond}\;((\mathrel{\wedge})\comp (\neg \comp \Varid{sep}\times\p1))\;(\succ \comp \p2\comp \p2,\p2\comp \p2)}}}
%
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 final}\mathbin{::}\Conid{String}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 final}\;\Varid{str}\mathrel{=}\Varid{forAll}\;\Varid{genSafeString}\mathbin{\$}\lambda \Varid{str}\to (\Varid{toInteger}\;(\Varid{wc\char95 w}\;\Varid{str})\equiv \Varid{toInteger}\;(\Varid{wc\char95 w\char95 final}\;\Varid{str})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genSafeChar}\mathbin{::}\Conid{Gen}\;\Conid{Char}{}\<[E]%
\\
\>[B]{}\Varid{genSafeChar}\mathrel{=}\Varid{elements}\;([\mskip1.5mu \text{\tt 'a'}\mathinner{\ldotp\ldotp}\text{\tt 'z'}\mskip1.5mu]\plus [\mskip1.5mu \text{\tt '~'},\text{\tt '\char92 t'},\text{\tt '\char92 n'}\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseB\char95 tree}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{f}{}\<[29]%
\>[29]{}\times(\map \;(\Varid{g}\times\Varid{f}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataB\char95 tree}\;\Varid{g}\mathrel{=}{}\<[17]%
\>[17]{}\Varid{g}\comp (\Varid{recB\char95 tree}\;(\Varid{cataB\char95 tree}\;\Varid{g}))\comp \Varid{outB\char95 tree}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\xymatrix@C=3cm{
    \ensuremath{\Conid{B\char95 Tree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataB\char95 tree}\;\Varid{g}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{B\char95 Tree}\;\Conid{A}\times(\Conid{A}\times\Conid{B\char95 treeA})\mathbin{*})}
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A}\mathbin{*})\mathbin{*}}
...
\\
     \ensuremath{\Conid{A}\mathbin{*}}
            \ar[u]^-{\ensuremath{\Varid{anaB\char95 tree}\;\Varid{g}}}
            \ar[r]_-{\ensuremath{\Varid{f}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A}\mathbin{*})\mathbin{*}}
            \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}(\Varid{anaB\char95 tree}\;\Varid{g}\times\map \;(\Varid{id}\times\Varid{anaB\char95 tree}\;\Varid{g}))}}
}
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{inord}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{inord}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{id}\times\Varid{aux})}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{aux}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp ((\Varid{singl}\comp \p1)\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\xymatrix@C=3cm{
    \ensuremath{\Conid{B\char95 Tree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataB\char95 tree}\;\Varid{inord}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{B\char95 Tree}\;\Conid{A}\times(\Conid{A}\times\Conid{B\char95 treeA})\mathbin{*})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((\Varid{cataB\char95 tree}\;\Varid{inord})\times(\map \;(\Varid{id}\times\Varid{cataB\char95 tree}\;\Varid{inord})))}}
           \ar[l]_-{\ensuremath{\Varid{inB\char95 tree}}}
\\
     \ensuremath{\Conid{A}\mathbin{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A}\mathbin{*})\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{inord}}}
}
...
\\
\>[B]{}\Varid{largestBlock}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{lb}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{lb}\mathrel{=}\alt{\underline{\mathrm{0}}}{\uncurry{\Varid{max}}\comp \conj{\length \comp \p2}{\uncurry{\Varid{max}}\comp (\Varid{id}\times(\Varid{maximum}\comp \Varid{aux}))}}{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{aux}\mathrel{=}{}\<[30]%
\>[30]{}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{cons}\comp (\p2\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\xymatrix@C=3cm{
    \ensuremath{\Conid{B\char95 Tree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataB\char95 tree}\;\Varid{lb}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{B\char95 Tree}\;\Conid{A}\times(\Conid{A}\times\Conid{B\char95 treeA})\mathbin{*})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((\Varid{cataB\char95 tree}\;\Varid{lb})\times(\map \;(\Varid{id}\times\Varid{cataB\char95 tree}\;\Varid{lb})))}}
           \ar[l]_-{\ensuremath{\Varid{inB\char95 tree}}}
\\
     \ensuremath{\Conid{A}\mathbin{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A}\mathbin{*})\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{lb}}}
}
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mirrorB\char95 tree}\mathrel{=}\Varid{anaB\char95 tree}\;((\Varid{id}+(\Varid{join}\comp \Varid{inside}\comp \Varid{auxb2}))\comp \Varid{outB\char95 tree}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{auxb2}\mathrel{=}\Varid{id}\times\Varid{unzip}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{inside}\mathrel{=}\conj{\Varid{reverse}\comp \p1\comp \p2}{\Varid{reverse}\comp \Varid{cons}\comp \conj{\p1}{\p2\comp \p2}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{join}\mathrel{=}\conj{\Varid{head}\comp \p2}{\uncurry{\Varid{zip}}\comp \conj{\p1}{\Varid{tail}\comp \p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
     \ensuremath{\Conid{A}\mathbin{*}}
            \ar[u]^-{\ensuremath{\Varid{g}\mathrel{=}\Varid{anaB\char95 tree}\;(\Varid{id}\mathbin{+}(\Varid{join}\comp \Varid{inside}\comp \Varid{auxb2}))\comp \Varid{outB\char95 tree}}}
            \ar[r]_-{\ensuremath{\Varid{f}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A}\mathbin{*})\mathbin{*}}
            \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}(\Varid{anaB\char95 tree}\;\Varid{g}\times\map \;(\Varid{id}\times\Varid{anaB\char95 tree}\;\Varid{g}))}}
...
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{s},[\mskip1.5mu (\Varid{h},\Varid{l})\mskip1.5mu])\;\mathbf{where}\;(\Varid{s},\Varid{l})\mathrel{=}\Varid{partB\char95 tree}\;(\mathbin{<}\Varid{h})\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{partB\char95 tree}\;\Varid{p}\;[\mskip1.5mu \mskip1.5mu]{}\<[32]%
\>[32]{}\mathrel{=}([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{partB\char95 tree}\;\Varid{p}\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{p}\;\Varid{h}{}\<[32]%
\>[32]{}\mathrel{=}\mathbf{let}\;(\Varid{s},\Varid{l})\mathrel{=}\Varid{partB\char95 tree}\;\Varid{p}\;\Varid{t}\;\mathbf{in}\;(\Varid{h}\mathbin{:}\Varid{s},\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{otherwise}\mathrel{=}\mathbf{let}\;(\Varid{s},\Varid{l})\mathrel{=}\Varid{partB\char95 tree}\;\Varid{p}\;\Varid{t}\;\mathbf{in}\;(\Varid{s},\Varid{h}\mathbin{:}\Varid{l}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{qSortB\char95 tree}\mathrel{=}\Varid{hyloB\char95 tree}\;\alt{\Varid{nil}}{\Varid{inord}}\;\Varid{lsplitB\char95 tree}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{inord}\mathrel{=}\mathsf{conc}\comp (\Varid{id}\times(\Varid{concat}\comp (\map \;\Varid{cons}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\xymatrix@C=3cm{
    \ensuremath{\Conid{A}\mathbin{*}}
           \ar[d]_-{\ensuremath{\Varid{ana}\;\Varid{lsplitB\char95 tree}}}
            \ar[r]^-{\ensuremath{\Varid{lsplitB\char95 tree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{*}\times(\Conid{A}\times\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((\Varid{ana}\;\Varid{lsplitB\char95 tree})\times\map \;(\Varid{id}\times\Varid{ana}\;\Varid{lsplitB\char95 tree}))}}
\\
     \ensuremath{\mathit B}
        \ar[d]_-{\ensuremath{\Varid{cata}\;\Varid{inordB\char95 tree}}}
        \ar[r]^-{\ensuremath{\Varid{outB\char95 tree}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\mathit B\times(\Conid{A}\times\mathit B)}
           \ar[l]^-{\ensuremath{\Varid{inB\char95 tree}}}
            \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}((\Varid{cata}\;\Varid{inordB\char95 tree})\times\map \;(\Varid{id}\times\Varid{cata}\;\Varid{inordB\char95 tree}))}}
\\
    \ensuremath{\Conid{A}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\Conid{A}\times\Conid{A})}
        \ar[l]^-{\ensuremath{\Varid{inordB\char95 tree}}}
}
...
\\
\>[B]{}\Varid{dotB\char95 tree}\mathrel{=}\Varid{dotpict}\comp \Varid{bmap}\;\Varid{nothing}\;(\Conid{Just}\comp \Varid{init}\comp \Varid{concat}\comp (\map \;(\plus \text{\tt \char34 |\char34}))\comp (\map \;\Varid{show}))\comp \Varid{cB\char95 tree2Exp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cB\char95 tree2Exp}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\underline{(\Conid{Var}\;\text{\tt \char34 nil\char34})}}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{aux}\mathrel{=}\uncurry{(\Conid{Term})}\comp (\Varid{id}\times\Varid{cons})\comp \conj{\p1\comp \p2}{\conj{\p1}{\p2\comp \p2}}\comp (\Varid{id}\times\Varid{unzip}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ana{\Varid{ga}~\Varid{gb}}_A\mathrel{=}\Varid{inA}\comp (\Varid{id}+\ana{\Varid{ga}~\Varid{gb}}_A{}\<[42]%
\>[42]{}\times\ana{\Varid{ga}~\Varid{gb}}_B)\comp \Varid{ga}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{ga}\mathrel{=}\alt{\underline{\text{\tt \char34 A\char34}}}{\mathsf{conc}}{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{gb}\mathrel{=}\alt{\underline{\text{\tt \char34 B\char34}}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\iffalse
...
\column{23}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 4\char95 6}\mathbin{::}\Conid{Integer}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 4\char95 6}\;\Varid{n}\mathrel{=}(\Varid{n}\geq \mathrm{0}\mathrel{\wedge}\Varid{n}\mathbin{<}\mathrm{24})\mathbin{==>}\Varid{lshG}\;\Varid{n}\equiv \Varid{fibsucc}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{lshG}\mathrel{=}\Varid{toInteger}\comp \length \comp \Varid{showAlgae}\comp \Varid{generateAlgae}\comp \Varid{fromInteger}{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{fibsucc}\mathrel{=}\Varid{fib}\comp \succ {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{permuta}\;\Varid{l}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu (\Varid{h},\Varid{t})\leftarrow \Varid{getR}\;\Varid{l};\Varid{x}\leftarrow \Varid{permuta}\;\Varid{t};\Varid{return}\;(\Varid{h}\mathbin{:}\Varid{x})\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{eliminatoria}\;(\Conid{Leaf}\;\Varid{x})\mathrel{=}\Varid{return}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{eliminatoria}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{v}\leftarrow \Varid{eliminatoria}\;\Varid{x};\Varid{z}\leftarrow \Varid{eliminatoria}\;\Varid{y};\Varid{jogo}\;(\Varid{v},\Varid{z})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
